...
import (
	...
	"github.com/telecom-cloud/telecomcloud-sdk-go/service/als/types/vpce"
)
...
func main() {
	...
	req := &vpce.CreateVPCERequest{
		RegionId: "bb9fdb42056f11eda1610242ac110002",
		VpcId:    "vpc-2hygfqry5l",
		SubnetId: "subnet-9yiocjw6ts",
	}

	resp, raw, err := client.VPCE().CreateVPCE(ctx, req)
	if err != nil {
		fmt.Println(err)
		return
	}
