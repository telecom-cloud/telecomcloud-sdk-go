...
import (
	...
	cluster "github.com/telecom-cloud/telecomcloud-sdk-go/service/ccse/types/cluster"
)
...
func (s *clusterClient) ListClustersPage(ctx context.Context, req *cluster.ListClustersPageRequest, reqOpt ...config.RequestOption) (resp *cluster.ListClustersPageResponse, rawResponse *protocol.Response, err error) {
	...
	ret, err := s.client.R().
		...
		Execute(http.MethodGet, "/v2/cce/clusters/page")
	if err != nil {
		return nil, nil, err
	}
...
func (s *clusterClient) ListClusterBindingNamespaces(ctx context.Context, req *cluster.ListClusterBindingNamespacesRequest, reqOpt ...config.RequestOption) (resp *cluster.ListClusterBindingNamespacesResponse, rawResponse *protocol.Response, err error) {
	openapiResp := &openapi.Response{}
	openapiResp.ReturnObj = &resp
	...
	ret, err := s.client.R().
		...
		SetRequestOption(reqOpt...).
		SetResult(openapiResp).
		Execute(http.MethodGet, "/v2/cce/clusters/:clusterId/binding/namespaces")
	if err != nil {
		return nil, nil, err
	}
