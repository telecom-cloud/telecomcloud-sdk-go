...
import (
	...
	plugin "github.com/telecom-cloud/telecomcloud-sdk-go/service/ccse/types/plugin"
)
...
func (s *pluginClient) CheckPluginExist(ctx context.Context, req *plugin.CheckPluginExistRequest, reqOpt ...config.RequestOption) (resp *plugin.CheckPluginExistResponse, rawResponse *protocol.Response, err error) {
	...
	ret, err := s.client.R().
		...
		Execute(http.MethodGet, "/v2/cce/clusters/:clusterId/plugininstance/:instanceName/exists")
	if err != nil {
		return nil, nil, err
	}
...
func ConfigDefaultPluginClient(ops ...Option) (err error) {
	defaultPluginClient, err = NewPluginClient(baseDomain, ops...)
	return
}
