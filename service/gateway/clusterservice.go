...
import (
	...
	cluster "github.com/telecom-cloud/telecomcloud-sdk-go/service/gateway/types/cluster"
)
...
func (s *clusterClient) GetCluster(ctx context.Context, req *cluster.GetClusterRequest, reqOpt ...config.RequestOption) (resp *cluster.GetClusterResponse, rawResponse *protocol.Response, err error) {
	...
	ret, err := s.client.R().
		...
		Execute(http.MethodPost, "/api/openApi/paas/ccse/api/v2/clusters/{prodInstId}/getServerlessClusterInfo")
	if err != nil {
		return nil, nil, err
	}
