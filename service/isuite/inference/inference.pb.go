...
var file_inference_proto_rawDesc = []byte{
	...
	0x6f, 0x61, 0x72, 0x64, 0x73, 0x32, 0x8d, 0x0c, 0x0a, 0x10, 0x49, 0x6e, 0x66, 0x65, 0x72, 0x65,
	...
	0x6e, 0x63, 0x65, 0x49, 0x64, 0x2f, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x12, 0x9d, 0x01,
	...
	0x73, 0x65, 0x22, 0x39, 0xca, 0xc1, 0x18, 0x35, 0x2f, 0x63, 0x63, 0x73, 0x65, 0x2f, 0x69, 0x73,
	0x75, 0x69, 0x74, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x69, 0x6e, 0x66, 0x65,
	0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x2f, 0x3a, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63,
	0x65, 0x49, 0x64, 0x2f, 0x64, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x1a, 0x26, 0x92,
...
var file_inference_proto_depIdxs = []int32{
	...
	21, // 33: proto.InferenceService.GetInferenceEvent:input_type -> proto.GetInferenceEventRequest
	23, // 34: proto.InferenceService.GetInferenceLogs:input_type -> proto.GetInferenceLogsRequest
	27, // 35: proto.InferenceService.GetInferenceMetrics:input_type -> proto.GetInferenceMetricsRequest
	31, // 36: proto.InferenceService.GetInferenceDashboard:input_type -> proto.GetInferenceDashboardRequest
	1,  // 37: proto.InferenceService.CreateInference:output_type -> proto.CreateInferenceResponse
	7,  // 38: proto.InferenceService.DeleteInference:output_type -> proto.DeleteInferenceResponse
	9,  // 39: proto.InferenceService.UpdateInference:output_type -> proto.UpdateInferenceResponse
	11, // 40: proto.InferenceService.GetInference:output_type -> proto.GetInferenceResponse
	13, // 41: proto.InferenceService.ListInference:output_type -> proto.ListInferenceResponse
	16, // 42: proto.InferenceService.StartInference:output_type -> proto.StartInferenceResponse
	18, // 43: proto.InferenceService.StopInference:output_type -> proto.StopInferenceResponse
	22, // 44: proto.InferenceService.GetInferenceEvent:output_type -> proto.GetInferenceEventResponse
	24, // 45: proto.InferenceService.GetInferenceLogs:output_type -> proto.GetInferenceLogsResponse
	28, // 46: proto.InferenceService.GetInferenceMetrics:output_type -> proto.GetInferenceMetricsResponse
	32, // 47: proto.InferenceService.GetInferenceDashboard:output_type -> proto.GetInferenceDashboardResponse
