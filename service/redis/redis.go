...
var baseDomain = "https://dcs2-global.ctapi.ctyun.cn"
...
func NewClientSet(baseDomain string, options ...Option) (ClientSet, error) {
	...
	accountCli, err := NewAccountClient(baseDomain, options...)
	if err != nil {
		return nil, err
	}
...
func (cs *clientSet) Account() AccountClient {
	return cs.accountCli
}
