...
import (
	...
	content "github.com/telecom-cloud/telecomcloud-sdk-go/service/als/types/content"
)
...
func (s *contentClient) GetLogs(ctx context.Context, req *content.GetLogsRequest, reqOpt ...config.RequestOption) (resp *content.GetLogsResponse, rawResponse *protocol.Response, err error) {
	...
	ret, err := s.client.R().
		...
		Execute(http.MethodPost, "/v1/content/getLogs")
	if err != nil {
		return nil, nil, err
	}
...
var defaultContentClient, _ = NewContentClient(baseDomain)

func ConfigDefaultContentClient(ops ...Option) (err error) {
	defaultContentClient, err = NewContentClient(baseDomain, ops...)
	return
}
...
func GetLogs(context context.Context, req *content.GetLogsRequest, reqOpt ...config.RequestOption) (resp *content.GetLogsResponse, rawResponse *protocol.Response, err error) {
	return defaultContentClient.GetLogs(context, req, reqOpt...)
}
