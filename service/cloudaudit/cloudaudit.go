...
var baseDomain = "https://cloudaudit-global.ctapi.ctyun.cn"
...
func NewClientSet(baseDomain string, options ...Option) (ClientSet, error) {
	...
	managerCli, err := NewManagerClient(baseDomain, options...)
	if err != nil {
		return nil, err
	}

	return &clientSet{
		managerCli: managerCli,
	}, nil
}

func (cs *clientSet) Manager() ManagerClient {
	return cs.managerCli
}
